...
class StoryService {
  Future<StoryNode> getNode(String nodeId) async {
    ...
    return StoryNode(
      ...
      contentBlocks: nodeData['contentBlocks'] != null
        ? List<ContentBlock>.from(nodeData['contentBlocks'].map((x) => ContentBlock.fromJson(x)))
        : null,
      culturalContextData: nodeData['culturalContextData'] as Map<String, dynamic>?,
      challenge: nodeData['challenge'] != null ? Challenge.fromJson(nodeData['challenge']) : null,
    );
  }
